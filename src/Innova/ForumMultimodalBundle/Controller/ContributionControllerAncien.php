...
class ContributionController extends Controller
{
  ...
  public function showContributionAction(Subject $subj)
  {
        ...
        return $this->render('InnovaForumMultimodalBundle:Forum:choiceContribution.html.twig', array('id' => $id, 'form' => $form->createView(), 'form2' => $form2->createView(), 'form3' => $form3->createView(),'listeContributions' => $listeContributions,'countContribution' => $countContribution,'countContribution' => $countContribution,'subject' => $subject,'consigne' => $consigne,));
  }
  public function addContributionAction(Subject $subj)
  {
    ...
    return $this->render('InnovaForumMultimodalBundle:Forum:addTextContribution.html.twig', array('form2' => $form->createView(),'id' => $id,'listeContributions' => $listeContributions,'countContribution' => $countContribution,'subject' => $subject,'consigne' => $consigne,));
  }
